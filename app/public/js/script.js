...
$(document).ready(function() {
  ...
  if($('.navbar')[0]) {
    ...
    Vue.component('my-container', {
      ...
      template: `
      <div v-bind:class="{active: isDim}" class="docker_container box-row">
        ...
        <div class="controls">
          <i class="fa fa-key" v-if="container.State.Status === 'running' && !ha_container" v-on:click="openModal('aws', container)" title="Load AWS Credentials"></i>
          <i class="fa fa-stop" v-on:click="stop" v-if="container.State.Status === 'running' && !ha_container" title="Stop Container"></i>
          <i class="fa fa-play" v-on:click="start" v-if="container.State.Status !== 'running'" title="Start Container"></i>
          <i class="fa fa-refresh" aria-hidden="true" v-if="!ha_container" v-on:click="restart" title="Restart Container"></i>
          <i class="fa fa-times" v-if="!ha_container" v-on:click="kill_container" aria-hidden="true" title="Remove Container"></i>
      ...
      computed: {
        ha_container: function() {
          return this.container.Name === 'docker-aws-proxy' || this.container.Name === 'docker-events'
        }
      },
      methods: {
...
},{"lodash":2,"nes":3}],2:[function(require,module,exports){
(function (global){
/**
 * @license
